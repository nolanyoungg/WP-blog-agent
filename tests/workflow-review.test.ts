...
test('only accepts a reply sent after its review request', () => {
  ...
  const row: BlogRow = { row: 2, blog_id: '1', blog_topic: 'Topic', blog_status: 'awaiting_review', review_requested_at: '2026-07-24T15:00:00.000Z' };
  ...
  assert.equal(workflow.replyIsCurrent({ ...row, review_requested_at: '' }, '2026-07-24T15:00:01.000Z'), false);
});
