...
test('refuses duplicate blog IDs before selecting a row', async () => {
  ...
  try {
    ...
    const sheet = XLSX.utils.aoa_to_sheet([['blog_id', 'blog_topic', 'blog_length', 'blog_type', 'blog_status', 'blog_created_date', 'blog_posted_date'], ['1', 'First', 500, 'short', 'pending', '', ''], ['1', 'Second', 500, 'short', 'pending', '', '']]);
