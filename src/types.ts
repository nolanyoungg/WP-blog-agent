...
export type BlogType = 'short' | 'medium' | 'long';
export interface BlogRow { row: number; blog_id: string; blog_topic: string; blog_length?: number; blog_type?: BlogType; blog_status: BlogStatus; blog_created_date?: string; blog_posted_date?: string; markdown_path?: string; review_status?: ReviewStatus; review_token?: string; model_used?: string; wordpress_post_id?: string; wordpress_url?: string; }
